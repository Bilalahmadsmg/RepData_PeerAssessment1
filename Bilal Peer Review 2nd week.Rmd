...
### Bilal's Peer Review Week2 Assgnment

##### This assignment makes use of data from a personal activity monitoring device. It collects data at 5 minute intervals through out the day. Data consists of two months of data from an anonymous individual collected during the months of October and November, 2012 and include the number of steps taken in 5 minute intervals per day.

##### Variables are 1. steps, 2. date (YYYY-MM-DD), and 3. Interval (5 minute interval i.d. of measurement)
